 ...
 */
public abstract class OldDataSource extends JavaLogging
{
    private static final MapList<String,OldDataSource> map = new HashMapList<>();
    protected final String name;
    protected OldDataSource attached;
    ...
    public OldDataSource(String name)
    {
        this.name = name;
    ...
    public static List<OldDataSource> get(String name)
    {
        return map.get(name);
    }
    public static OldDataSource getSingle(String name)
    {
        List<OldDataSource> list = map.get(name);
        switch (list.size())
        {
            case 0:
                return null;
    ...
    protected void attach(OldDataSource ds)
    {
        if (attached != null)
        {
    ...
    public static Collection<OldDataSource> getDataSources()
    {
        Set<OldDataSource> set = new HashSet<>();
