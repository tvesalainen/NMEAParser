...
public enum NMEAProperty
{
	...
	DESTINATION_CLOSING_VELOCITY(NMEACategory.WAYPOINT, UnitType.KNOT, float.class),
	...
	SPEED_OVER_GROUND(NMEACategory.SPEED, UnitType.KNOT, float.class),
	...
	VELOCITY_TO_WAYPOINT(NMEACategory.WAYPOINT, UnitType.KNOT, float.class),
	...
	WATER_SPEED(NMEACategory.SPEED, UnitType.KNOT, float.class),
