...
,@Terminal(left="ais_state", expression="[01]{2}", doc="AIS Class A", radix=2)
...
,@Terminal(left="ais_version", expression="[01]{2}", doc="AIS Version", radix=2)
...
protected void txrx_2(int arg, @ParserContext("aisData") AISObserver aisData){}
    ...
    protected void radio(int radio, @ParserContext("aisData") AISObserver aisData)
    {
